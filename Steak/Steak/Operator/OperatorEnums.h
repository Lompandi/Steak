...
enum class Memorily {
	...
	/*0x4E*/ ENTER,		//Make stack frame for procedure params
	/*0x4F*/ LEAVE,		//High level procedure exit
	...
	/*0x9A*/ LAST		//Place holder
};

enum class Group {
	/*0x00*/ _null,		//No Operator

	/*0x9A*/ Immediate = (int)Memorily::LAST,	//Airthmetic Operations
	/*0x9B*/ Shift,		//Shift/Rotate Operations
	/*0x9C*/ Unary,		//Multiplication, Division, Test, Negate Operations
	/*0x9D*/ Four,		//Increment, Decrement
	/*0x9E*/ Five,		//Increment, Decrement, Call, Jump, Push Operations
	/*0x9F*/ TwoByte,	//Two-Byte Operations

	/*0xA0*/ LAST,		//Placeholder(attacher)
};


enum class Prefix {
	/*0x000*/ _null,			//No Operator
		
	/*0x100*/ ES = 0x00100,		//E Segment Register Prefix
	/*0x200*/ CS = 0x00200,		//C Segment Register Prefix
	/*0x300*/ SS = 0x00400,		//S Segment Register Prefix
	/*0x400*/ DS = 0x00800,		//D Segment Register Prefix
	/*0x500*/ FS = 0x01000,		//F Segment Register Prefix
	/*0x600*/ GS = 0x02000,		//G Segment Register Prefix
	...
	/*0x80000*/ REX		= 0x80000,		//Rex prefix for 64-bits mode

	/*0x40001*/ LAST					//Attacher
};
